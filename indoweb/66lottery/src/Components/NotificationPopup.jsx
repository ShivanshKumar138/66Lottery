  ...
  return (
    ...
    >
      <Box
        sx={{
          width: "90%",
          maxWidth: "333px", // Same width
          maxHeight: "444px", // Same height
          bgcolor: "#ffffff",
          borderRadius: "15px",
          boxShadow: 24,
          display: "flex",
      ...
      >
        ...
        <Box
          sx={{
            ...
            justifyContent: "center",
            alignItems: "center",
            background: "linear-gradient(90deg, #FF952A 0%, #FF952A 100%)",  // Gradient header
            borderTopLeftRadius: "15px",
            borderTopRightRadius: "15px",
            p: 2,
            color: "#ffffff",
        ...
        {/* Confirm Button with Same Orange Gradient */}
        <Box
          sx={{
            textAlign: "center",
            p: 2,
        ...
        >
          <Button
            ...
            sx={{
              ...
              px: 3,
              py: 1,
              background: "linear-gradient(90deg, #FF952A 0%, #FF952A 100%)",  // Orange gradient button
              color: "#ffffff",
              "&:hover": {
                background: "linear-gradient(90deg, #FF952A 0%, #FF952A 100%)",  // No color change on hover
              },
            }}
            onClick={handleConfirm}
          >
