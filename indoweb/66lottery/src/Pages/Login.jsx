          ...
          <form onSubmit={handleEmailLogin}>
            ...
            <TabPanel value={tabValue} index={0}>
              <Box display="flex" alignItems="center" mt={2}>
                <img src="https://in.piccdn123.com/static/_template_/orange/img/sign/mobile.png" style={{
                  width:"30px",
                  height:"30px"
                }}/>
                <FormLabel
...
/>
            ...
            <Box display="flex" alignItems="center" mt={2}>
              <img src="https://in.piccdn123.com/static/_template_/orange/img/sign/pwd.png" style={{
                width:"30px",
                height:"30px"
              }}/>
              <FormLabel
